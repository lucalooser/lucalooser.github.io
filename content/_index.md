---
title: ''
summary: 'Luca Looser — PhD Candidate in Economics at Universitat Pompeu Fabra.'
date: 2026-08-22
type: landing
...
sections:
  - block: markdown
    ...
    content:
      title: ''
      text: |-
        <div class="academic-home-section hero-section">
          <div class="hero-copy">
            <h1>Luca Looser</h1>
            ...
            <a class="hero-email" href="mailto:luca.looser@upf.edu">luca.looser@upf.edu</a>
          </div>
          <div class="hero-photo-wrap">
            <img class="hero-photo" src="/uploads/luca_looser_profile.png" alt="Luca Looser">
          </div>
        </div>
    design:
      columns: '1'
      css_class: 'homepage-markdown-block hero-markdown-block'
  ...
  - block: markdown
    ...
    content:
      title: ''
      text: |-
        <div class="academic-home-section jmp-section">
    ...
    design:
      columns: '1'
      css_class: 'homepage-markdown-block'
  ...
  - block: markdown
    ...
    content:
      title: ''
      text: |-
        <div class="academic-home-section research-preview-section">
          <div class="section-heading-row">
            <div>
              <div class="section-kicker">OTHER RESEARCH</div>
              <h2>Research</h2>
            </div>
          ...
          <div class="research-preview-grid">
            <article class="research-preview-card">
              ...
              <h3>Unequal Global Convergence</h3>
              <p class="paper-authors">with Shoumitro Chatterjee, Elisa Giannone, Tatjana Kleineberg and Kan Kuno</p>
            ...
            <article class="research-preview-card">
              ...
              <p class="paper-authors">with Chanont Banternghansa and Elisa Giannone</p>
